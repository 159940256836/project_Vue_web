                            ...
                            <div class="panel panel_buy">
                                ...
                                <div class="bd bd_limited" v-show="btnList[0].check==true">
                                    <Form ref="formValidate">
                                        ...
                                        <FormItem>
                                            <Input @on-keyup="keyEvent" v-model="form.buy.limitAmount" :placeholder="$t('exchange.buynum')">
                                            </Input>
                                        ...
                                        <div class="total buy_total">
                                            ...
                                            <!-- 5.24添加 -->
                                            <!-- <span v-if="form.buy.isPriceState">
                                                {{ form.buy.isPrice }}
                                            </span> -->
                                        </div>
                                        <Button
...
import { setTimeout } from 'timers';
    ...
    export default {
        ...
        methods: {
            ...
            keyEvent(event) {
                if (this.form.buy.limitAmount == 0 || this.form.buy.limitAmount == '') {
                    this.form.buy.isPriceState = false
                }
