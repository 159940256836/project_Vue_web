                            ...
                            <div class="panel panel_buy">
                                ...
                                <div class="bd bd_limited" v-show="btnList[2].check==true">
                                    <Form ref="formValidate" :label-width="50">
                                        ...
                                        <Button class="bg-green" @click="buyWithStopPrice" v-show="isLogin" :loading="loadingButton3" icon="checkmark-round">
                                            <!--{{$t("exchange.buyin")}}{{currentCoin.coin}}-->
                                            <span>
                                ...
                                <div class="bd bd_market" v-show="btnList[1].check==true">
                                    <Form ref="formValidate">
                                        ...
                                        <Button class="bg-green" @click="buyWithMarketPrice" v-show="isLogin" :loading="loadingButton2" icon="checkmark-round">
                                            <span>
                            ...
                            <div class="panel panel_sell">
                                ...
                                <div class="bd bd_limited" v-show="btnList[0].check==true">
                                    <Form ref="formValidate">
                                        ...
                                        <Button class="bg-red" @click="sellLimitPrice" v-show="isLogin" :loading="loadingButton4" icon="checkmark-round">
                                ...
                                <div class="bd bd_limited" v-show="btnList[2].check==true">
                                    <Form ref="formValidate" :label-width="50">
                                        ...
                                        <Button class="bg-red" @click="sellStopPrice" v-show="isLogin" :loading="loadingButton6" icon="checkmark-round">
                                            <span>
                                ...
                                <div class="bd bd_market" v-show="btnList[1].check==true">
                                    <Form ref="formValidate">
                                        ...
                                        <!--<Slider v-model="value6" :step="25" show-stops min="0" max="100"></Slider>-->
                                        <!--</FormItem>-->
                                        <Button class="bg-red" @click="sellMarketPrice" v-show="isLogin" :loading="loadingButton5" icon="checkmark-round">
                                            <!--{{$t("exchange.sellout")}}{{currentCoin.coin}}-->
                                            <span>
