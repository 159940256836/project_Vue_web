  ...
  <div class="specail">
        ...
        <div class="abstract">
          ...
          <p style="color: #FE5C5C;">
            ...
            <span
                    ...
                    class="blue"
            >
              <i class="iconfont iconcopy" style="font-size: 22px;color: #FE5C5C"></i>
            </span>
          </p>
        </div>
      </div>
    ...
    >
      <FormItem :label="$t('openGoolePage._GoogleVerificationCode')" prop="code">
        <Input v-model="formCode.code"/>
      </FormItem>
      <FormItem>
        <Button type="primary" style="width:100%;border-radius:0;height:40px;font-size:14px;background: #E62B25;border: 0;" @click="sure('formCode')">
