  ...
  <div class="content-wrap">
    <div class="container chat-in-box" id="List">
      <p style="padding: 10px 0 10px 20px;font-size: 18px;">
        ...
        >
        <span style="font-size:16px;color: #333;">{{$t('otc.chat.orderDetails')}}</span>
      </p>
      <Row class="chat-in">
        <div class="trading">
        ...
        <div class="account-main">
          ...
          <div class="account-right">
            <div style="padding: 13px 0;" v-if="tradeType==0">
              ...
              <span>
                  <b style="color: #666">{{$t('otc.chat.note')}}：</b>
              </span><br>
              <span style="color: #666">{{$t('otc.chat.notetip')}}</span><br>
            </div>
        ...
        <p class="online-message">{{ $t('otc.chat.online_message') }}</p>
