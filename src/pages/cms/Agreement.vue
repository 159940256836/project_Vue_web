            ...
            <div class="ww">
                <div class="container" id="List">
                    <div class="agreen-cont">
                        ...
                        <h4>二、{{$t("foot.p233")}}</h4>
                        <p>2.1. {{$t("foot.p234")}}</p>
                        <p class="text-index">{{$t("foot.p235")}}</p>
                        <p>2.2. {{$t("foot.p236")}}</p>
                        <p class="text-index">{{$t("foot.p237")}}</p>
                        <p>2.3. {{$t("foot.p238")}}</p>
                        <p class="text-index">{{$t("foot.p239")}}</p>
                        <p>2.4. {{$t("foot.p240")}}</p>
                        <p class="text-index">{{$t("foot.p241")}}</p>
                        <h4>三、{{$t("foot.p242")}}</h4>
                        <p>3.1. {{$t("foot.p243")}}</p>
                        <p>3.2. {{$t("foot.p244")}}</p>
                        <p>3.3. {{$t("foot.p245")}}</p>
                        ...
                        <p>5.7 {{$t("foot.p259")}}</p>
                        <h4>六、{{$t("foot.p260")}}</h4>
                        <p class="text-index">{{$t("foot.p261")}}</p>
                        <p>i. {{$t("foot.p262")}}</p>
                        <p>ii. {{$t("foot.p263")}}</p>
                        <p>iii. {{$t("foot.p264")}}</p>
                        <p>iv. {{$t("foot.p265")}}</p>
                        <p>v. {{$t("foot.p266")}}</p>
                        <p class="text-index">{{$t("foot.p267")}}</p>
                        <h4>七、{{$t("foot.p268")}}</h4>
                        <p>{{$t("foot.p269")}}</p>
                    </div>
                </div>
...
.new_agreement{
   ...
   .content-wrap[data-v-2a3df2d0]{
    ...
    .container{
        background:#fff ;
        order:1px solid rgba(17,21,48,1) ;
        color:#666666;
        font-size:14px;
        padding:30px;
        margin-top:22px;
