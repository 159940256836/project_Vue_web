  ...
  <div>
    <div id="fullpage">
      ...
      <div id="pagetips">
        ...
        <!-- <div class="frinend_wakuang">
          <router-link to="/notice">挖矿倍增计划：邀请好友挖矿，赚取更多利益&nbsp;→</router-link>
        </div> -->
      </div>
      <div id="progress">
        <div class="title">
          <span class="already">{{$t('progress.already')}}{{already}}&nbsp;BHB</span>
          <span class="total">{{$t('progress.total')}}</span>
        </div>
        <Progress :percent="progress" :stroke-width="30" :hide-info="true"></Progress>
      </div>
      <div id="page6">
        <ul class="page6-out">
          <li class="page6-list" style="width:33%">
            <div class="list-op">
              <div class="list-opBHB">{{$t('index.circulation')}}</div>
              <div class="text">
                <span class="num">{{safetyAndAssoction | toFixed(2)}}</span>
                <span class="type">BHB</span>
              </div>
            </div>
          </li>
          <li class="page6-list" style="width:28%">
            <div class="list-op">
              <div class="list-opBHB">{{$t("index.hourEth")}}</div>
              <div class="text">
                <span class="num">{{currentBonusETHBnous|toFixed(4)}}</span>
                <span class="type">ETH</span>
              </div>
            </div>
          </li>
          <li class="page6-list" style="width:39%">
            <div class="list-op">
              <div v-if="lang == 'English'">
                <div class="list-opBHB" style="text-align:left;">
                  <span>{{$t("index.yesterdayEth")}}</span>
                </div>
                <span class="num2">{{yesDayCashDividensBonusETH|toFixed(4)}}</span>
                <span class="num2">ETH</span>
              </div>
              <div v-else>
                <div class="list-opBHB" style="text-align:left;">
                  <span>{{$t("index.yesterdayEth")}}</span>
                  <span class="num2">{{yesDayCashDividensBonusETH|toFixed(4)}}</span>
                  <span class="num2">ETH</span>
                  <!-- <router-link to="/distribute/yesterday">{{yesDayMineAmountBHB}} BHB</router-link> -->
                </div>
              </div>
              <div>
                <div v-if="lang == 'English'" class="special">
                  <span>{{$t("index.yesterday")}}</span><br>
                  <span class="num">{{yesDayMineAmountBHB|toFixed(2)}}</span>
                  <span class="num">&nbsp;BHB</span>
                  <span>[</span>
                  <router-link to="/notice" class="num">{{$t('index.checkMineprinciple')}}</router-link>
                  <span>]</span>
                </div>
                <div v-else class="special">
                  <span>{{$t("index.yesterday")}}</span>
                  <span class="num">{{yesDayMineAmountBHB|toFixed(2)}}</span>
                  <span class="num">BHB</span>
                  <!-- <router-link style="color: #f0a70a" to="/feereturn">{{yesDayCashDividensBonusETH}} BHB</router-link> -->
                  <span>[</span>
                  <router-link to="/helpdetail?cate=1&id=5&cateTitle=常见问题" class="num">{{$t('index.checkMineprinciple')}}</router-link>
                  <span>]</span>
                </div>
              </div>
            </div>
      ...
      <div class="section" id="page5">
        ...
        <ul class="download">
          ...
          <li class="wrapper">
            ...
            <div class="abstract">
              <div class="image"><img src="../../assets/images/andraio.png" alt=""></div>
              <div class="content">
          ...
          <li class="wrapper">
            ...
            <div class="abstract">
              <div class="image"><img src="../../assets/images/ios.png" alt=""></div>
              <div class="content">
                <span>iPhone</span>
              </div>
            </div>
...
#page5 {
  ...
  padding: 0 14%;
  position: relative;
  background: #fff url("../../assets/images/app-download.png") no-repeat 0 0;
