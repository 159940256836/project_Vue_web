      ...
      <div class="nav-right col-xs-12 col-md-10 padding-right-clear">
        <div class="nav-right_content">
          <div style="display:flex; padding-left:35px; padding-top:40px;">
            <div>
              <div style="font-size:14px; color:#333333; margin-bottom:23px;">{{$t('apiAdmin.Exclusivinvita')}}</div>
            ...
            <div style="margin-left:131px;">
              <div style="font-size:14px; color:#333333;margin-bottom:23px;">{{$t('apiAdmin.Excllink')}}</div>
              <div class="copy">
                <span class="code">{{qrcode.value}}</span>
                <span style="margin-left:20px;color: #DDDDDD">|</span>
                <span class="span2">
                  <a
          ...
          <div class="invite">
            <div class="invite_conter">
              <div class="invite_left">
                ...
                <div class="invite_left2">{{$t('apiAdmin.Totnumbinvitations')}}：{{dataPromoteFriends.totalElements}}
                </div>
              </div>
        ...
        <div class="bill_box rightarea padding-right-clear record account-box">
          <div style="display:flex; background: #eeeeee;height:55px;">
            <div
