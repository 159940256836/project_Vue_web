<template>
  <div class="apimanagement bcd">
    <div class="nav-rights">
      <div class="main">
        <Card :bordered="false" class="card1" style="border-radius: 0">{{$t('apiAdmin.apiAdmin')}}</Card>
        <Card :bordered="false" class="content card2" style="border-radius: 0">
            ...
            <div class="prompt">
              ...
              <ul style="margin: 0 15px;">
                <li>
                  ...
                  <a style="color: #E62B25" href="https://bdwexchange.github.io/" target="_blank">{{$t('apiAdmin.apiDoc')}}</a>
                  {{$t('apiAdmin.howUse')}}
                </li>
          ...
          <div class="add" style="width:400px;margin: 0 auto; margin-top:86px;">
            <Form :label-width="60" :model="formItem">
            ...
            <div style="margin-left:60px; font-size:12px; color:#666666">{{$t('apiAdmin.Thekeybound')}}</div>
            <Button
                    @click="codeVerify"
                    style="
                width:85%;
     ...
     "
      ...
      >
        ...
        <div slot="footer">
          ...
          <Button :cancel-text="$t('apiAdmin.cancel')"
                  :ok-text="$t('apiAdmin.okText')"
                  @click="onDel(id)"
                  @on-cancel="del=false"
                  class="edit_let_buttom edit_let_buttom_new"
      ...
      >
        <Form :model="formItem" label-position="top">
          <FormItem
                  ...
                  v-if="isPhoneCode"
          >
            <Input size="large" v-model="formItem.code">
              <div
                      class="timebox"
                      slot="append"
              ...
              >
                ...
                <Button :disabled="addPhoneDisabled" v-if="addPhoneDisabled">
        ...
        >
          <Form :model="editorFormItem" label-position="top">
            <FormItem
                    ...
                    v-if="isPhoneCode"
            >
              <Input size="large" v-model="editorFormItem.code">
