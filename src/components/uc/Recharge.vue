  ...
  methods: {
    ...
    getList(pageNo) {
      ...
      let page = pageNo,
        limit = 10,
        type = 0,
        params = { memberId, page, limit, type };
      this.$http
        ...
        .then(response => {
          ...
          if (resp.code == 0) {
            if (resp.data) {
              ...
              this.allTableRecharge = trueData.hits || [];
  ...
  computed: {
    tableColumnsRecharge() {
      ...
      columns.push({
        ...
        align: "center",
        render: (h, param) => {
          let str = param.row._source.create_time;
          return h("div", {}, str);
        }
      });
      columns.push({
        ...
        align: "center",
        render: (h, param) => {
          let str = param.row._source.symbol;
          return h("div", {}, str);
        }
      });
      columns.push({
        ...
        align: "center",
        render: (h, param) => {
          let str = param.row._source.address;
          return h("div", {}, str);
        }
      });
      columns.push({
        ...
        align: "center",
        render: (h, param) => {
          let str = param.row._source.amount;
          return h("div", {}, str);
        }
      });
      return columns;
