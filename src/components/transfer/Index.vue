  ...
  <div class="tab">
    ...
    >
      <div>
        <div style="margin-bottom:15px;">
          <div style="width:85%;line-height: 25px;text-align: right;margin-left: 3%;">
                        <span style="width:55px;display: inline-block;line-height: 40px;padding-right: 10px; color: #333;">
                            {{$t('coin.follow')}}:
                        </span>
        ...
        <div v-if="currencyData.modal"
             style="width: 85%;margin-bottom:25px;line-height: 25px;text-align: right;margin-left: 3%;">
      ...
      <div style="width:85%;line-height: 25px;margin-left: 3%;">
                <span style="width:50px;display: inline-block;line-height: 40px;text-align:right; color: #333;">
                    {{$t('coin.quantity')}}:
                </span>
        <Input
                v-model="num"
      ...
      <div style="margin-top:5px;padding-left:75px; color: #333;" v-if="currencyData.modal">
        {{$t('coin.available')}}:&nbsp;&nbsp;&nbsp;{{canUseNum}}
      </div>
      <div style="margin-top:5px;padding-left:75px; color: #333;" v-else>
