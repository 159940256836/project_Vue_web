...
module.exports = {
  ...
  common: {
    ...
    fund: {
      ...
      timeSave: 'save TD 08 - 16 10:00 — 08-21 20:30',
      timeRush: 'rush purchase BTC 08 - 22 — 20:00',
      rushPurchase: 'save money',
      rushPurchaseAmount: 'save amount',
      quantity: 'Please enter the deposit amount',
      ...
      second: 'S',
      preOrder: 'pre-order',
      pleasePreOrder: 'Please enter pre-order',
      // 存币记录
      moneyRecord: 'Save money record',
      MemberId: 'userID',
      lockCoinName: 'name',
      lockCoinUnit: 'coin',
      lockAmount: 'sum',
      ...
      error: 'failure',
      // 抢币记录
      robRecord: 'Save money record',
      moneyDeposited: 'Money deposited',
      availableQuantity: 'Available quantity',
      finished: 'finished',
      started: 'NotStarted',
      immediately: 'Snapped up immediately',
      activityContent : 'activity content',
      successful: 'successful',
      rewardDrop: 'Reward drop',
      transactionPrice: 'price',
      saleAmount: 'frontal',
      actualSaleAmount: 'purchase',
      airDropCoin: 'drop coin',
      airDropAmount: 'Drop lines',
      createTime: 'time',
      actStatus: 'status',
      activityContentInfo1: 'this',
      activityContentInfo2: '2折',
      activityContentInfo3: 'Preferential purchase BTC 500 pieces, while stock lasts',
      activityContentInfo4: 'save',
      activityContentInfo5: 'with up to 20 % discount',
      activityContentInfo6: 'individual',
      activityContentInfo7: 'Did not get the',
      activityContentInfo8: 'user',
      activityContentInfo9: 'BDWunite',
      activityContentInfo10: 'base',
      activityContentInfo11: 'air-drop',
      activityContentInfo12: '， drop',
      activityContentInfo13: 'Activity rules',
      activityContentInfo14: 'Involved in buying',
      activityContentInfo15: 'Activity must be in memory at the time of deposit coin activity',
      activityContentInfo16: 'Corresponding quantity',
      activityContentInfo17: 'Get snapped up',
      activityContentInfo18: 'Qualify and pre-order the maximum quantity',
      activityContentInfo19: 'deposit',
      activityContentInfo20: 'Need to lock up',
      activityContentInfo21: 'heaven',
      activityContentInfo22: 'Unlock, the system will automatically',
      activityContentInfo23: 'Return to your personal account',
      activityContentInfo24: 'rush',
      activityContentInfo25: 'All depositing users who meet the requirements can participate in the unified time buying after the deposit',
      activityContentInfo26: ', you need to recharge in advance',
      activityContentInfo27: 'To a personal account. Make sure',
      activityContentInfo28: 'There was more than a rush',
      activityContentInfo29: 'forehead, rob',
      activityContentInfo30: 'After successful purchase, the system will automatically deduct',
      activityContentInfo31: 'Quantity, if you do not have sufficient balance in your account, will be considered waived',
      activityContentInfo32: 'The pricing for the deposit currency during the activities of fire currency, currency, OK and BDW four',
      activityContentInfo33: 'The average price of a price',
      activityContentInfo34: 'After the end of the buying, there are 30 minutes clearing time, not to grab',
      activityContentInfo35: 'households, the system will be issued within three working',
      activityContentInfo36: 'Reward drop',
      activityContentInfo37: 'If in doubt, please consult BDW customer service.BDW reserves the right to the final interpretation of this activity',
      // BD 簡介
      introduce: 'introduce',
      possess: 'You can have',
      why: 'what is',
      brief: 'BD is a global general credit issued by the global professional website foundation of Cody network. BD is based on the powerful technology of block chain and designed and launched by BD\'s top developers in the world.BD is a decentralized digital asset, which is committed to building an ecological space integrating industry development and resource management services. It can be used and circulated in numerous scenes of BD ecology, with the purpose of allowing users to enjoy more rights in the BD ecosystem and opening up BD ecological industry services.',
      distribution: 'Distribution of distribution',
      operation: 'The foundation operates and will be released in 2022',
      operation1: 'total of 10 million',
      operation2: 'Some early shareholders buy. Released in 2022, 75 million',
      operation3: 'Total circulation',
      operation4: '5亿',
      operation5: 'Team motivation will be released year by year starting from 2022',
      ...
      // isotopicText: 'BD is applied to all kinds of applications of BDW global business and global ecosystem. It rewards users of the platform through value promotion and feeds back BDW platform and global ecology, thus providing growth and wireless growth space.',
      // enjoy: 'To enjoy the rights and interests',
      // enjoyText: 'The holder shall enjoy the corresponding interests of BDW is entire ecology, as well as the increased scarcity brought by BDW\'s continuous buyback destruction.',
      // buyBack: 'Repurchase destroyed',
      // buyBackText: 'BDW adopts regular repurchase of current nt dollars at market price, and 20% of global station income will be used for regular repurchase of BD and destruction.',
      // win: 'Win-win plan',
      // winText: 'Through in-depth cooperation with partners to promote the benign development of the industry, mutual benefit and mutual assistance, win-win market.',
      // function: 'Function of the rights and interests',
      // functionText: 'Invite friends to return commission right, can enjoy the discount of transaction fee and get the sub - card bonus.',
    }
  },
  new: {
  ...
  foot: {
    ...
    lockStatus: 'status',
    reason: 'reason',
    reasonCoin: 'Please enter the correct currency name',
  ...
  otc: {
    ...
    chat: {
      ...
      msg3: 'Minimum top-up amount：',
      msg31: 'Amounts less than the minimum amount will not be charged.',
      ...
      result_5: 'Canceled',
      msg7: 'Fund Password',
      msg7tip: 'The fund password cannot be empty',
      msg8tip: 'SMS verification code cannot be empty',
      msg81tip: 'The mailbox verification code cannot be empty',
      msg9tip: 'Google code cannot be empty',
  ...
  uc: {
    ...
    finance: {
      ...
      recharge: {
        ...
        msg1: 'Top up is prohibited',
        msg11: 'Other assets, any non',
        msg12: 'The asset recharge will not be recoverable.',
      ...
      withdraw: {
        ...
        msg0: 'importability',
        msg01: 'decimals',
        msg02: 'The withdrawal amount should not be less than the service fee',
        ...
        msg7: 'risk warning',
        msg8: 'Your currency on completion of the operation, the corresponding assets ownership will be for you to change for all people enjoy the target address of the account, please be sure to in the money before the operation, carefully check the currency address information, to ensure that the money belong to voluntary behavior, and confirm that does not involve any illegal pyramid selling, financing, fraud and other illegal situation, beware deceived, avoid to cause unnecessary damage to property.',
        ...
        numtip31: 'The withdrawal amount shall not be less than the minimum withdrawal amount',
        feetip1: 'The minimum fee is',
        feetip2: 'The maximum value is',
        time: 'Withdrawal time',
        status: 'Status',
        status_0: 'under review',
        status_1: 'await put coin',
        status_2: 'failed',
        status_3: 'succeed',
        status_4: 'transfer',
        status_5: 'Not approved',
        remark: 'Remark',
        add: 'Add',
    ...
    identity: {
      ...
      zhusnhu: 'Merchants have exclusive advertising booths, more flexible sales increase the probability of transactions',
      zhusnhu1: 'We provide one-to-one exclusive service for merchant users to improve transaction efficiency',
      zhusnhu2: 'Merchant users will have the privilege of lower fees than regular users',
