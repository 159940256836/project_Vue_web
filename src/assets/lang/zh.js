module.exports = {
    ...
    description: {
        ...
        // message3: 'BIHUO数字资产交易平台支持每秒1000笔交易，给用户带来酣畅淋漓\n的交易体验',
        title1: '安全',
        title2: '快捷',
        title3: '体验',
        ...
        message5: 'BIHUO国际数字加密资产交易平台手机客户端，专注掌上交易体验',
    },
    footer: {
        wechatkefu: "微信客服",
        notice: '平台公告',
    ...
    plate: {
        ...
        content1: "正如白皮书所描述的，BIHUO会拿出平台的80% (扣除税费后) 的收入分配给BIHUO持有者，20%的收入用来支持平台的研发及运营。",
    ...
    aboutUs: {
        c1: "BIHUO（币火）国际数字加密资产交易平台是一个综合数字资产交易平台,我们拥有领先的技术实力、优质的客户服务和良好的用户体验,为广大数字货币爱好者提供一个自由的网上交换的平台。",
        c2: "BIHUO（币火）国际数字加密资产交易平台同时还提供数字货币白皮书规划、加密算法调整、数字货币研发、交易平台上架一条龙的区块链服务。",
        c3: "BIHUO（币火）国际数字加密资产交易平台海外运营中心分别设立在新加坡，柬埔寨，马绍尔。国内北京，郑州，深圳三大办事处；中国总部设立在海南陵水清水湾国际信息产业园。"
    }
}